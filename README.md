...
### 📖 About Me
🎓 **Estudiante de Desarrollo de Aplicaciones Multiplataforma (DAM).** Mi enfoque principal es la convergencia entre el **desarrollo de software robusto** y la **inteligencia artificial**. Me apasiona crear herramientas que optimicen procesos y mejoren la experiencia del usuario, ya sea en entornos empresariales o en el mundo del *gaming* (addons/mods).

* 🔭 **Actualmente trabajando en:** Proyectos de automatización con IA y desarrollo Java/Kotlin.
* 🧠 **Aprendiendo:** Arquitecturas limpias y despliegue de modelos de IA locales.
...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Kanit&weight=600&size=22&pause=1000&color=F7DF1E&center=true&vCenter=true&width=600&lines=El+c%C3%B3digo+no+me+domina%2C+yo+lo+domino.;Lok'tar+ogar!+Code+Mode;Construyendo+el+futuro+con+IA.)](https://git.io/typing-svg)
